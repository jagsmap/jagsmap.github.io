...
L.marker([1.335207,-76.05897],{icon: mapmarker}).addTo(map).bindPopup("<b>Agroforesteria para la conservacion</b></br>Individual: 4</br>Stations: 59");
L.marker([-19.985526,-59.403879],{icon: mapmarker}).addTo(map).bindPopup("<b>Aires del Chaco/La Esperanza</b></br>Individual: 8</br>Stations: 76");
...
L.marker([15.10097,-84.73127],{icon: mapmarker}).addTo(map).bindPopup("<b>Darwin_Project_Honduras_2017-2018</b></br>Individual: 1</br>Stations: 37");
...
L.marker([17.715241,-89.547187],{icon: mapmarker}).addTo(map).bindPopup("<b>Dos Lagunas 2008</b></br>Individual: 6</br>Stations: 25");
...
L.marker([-19.669131,-58.705945],{icon: mapmarker}).addTo(map).bindPopup("<b>Estancia Chovoreca</b></br>Individual: 13</br>Stations: 62");
L.marker([-21.724104,-60.052265],{icon: mapmarker}).addTo(map).bindPopup("<b>Faro Moro</b></br>Individual: 5</br>Stations: 112");
...
L.marker([-20.717917,-59.969806],{icon: mapmarker}).addTo(map).bindPopup("<b>Jaguarete Renda</b></br>Individual: 12</br>Stations: 86");
...
L.marker([7.44548,-73.80283],{icon: mapmarker}).addTo(map).bindPopup("<b>Magdalena Medio</b></br>Individual: 11</br>Stations: 47");
L.marker([-0.66972,-76.44694],{icon: mapmarker}).addTo(map).bindPopup("<b>Maxus Road</b></br>Individual: 3</br>Stations: 26");
L.marker([17.706264,-89.888937],{icon: mapmarker}).addTo(map).bindPopup("<b>Mirador_2009</b></br>Individual: 8</br>Stations: 33");
L.marker([17.2778784,-90.34544548],{icon: mapmarker}).addTo(map).bindPopup("<b>PNLT 2009</b></br>Individual: 9</br>Stations: 26");
L.marker([-0.31900,-75.76380],{icon: mapmarker}).addTo(map).bindPopup("<b>Pakuya</b></br>Individual: 7</br>Stations: 20");
...
L.marker([-2.47485,-64.62042],{icon: mapmarker}).addTo(map).bindPopup("<b>RDSA_2012_2013</b></br>Individual: 0</br>Stations: 50");
L.marker([-2.47485,-64.62042],{icon: mapmarker}).addTo(map).bindPopup("<b>RDSA_2013_2014</b></br>Individual: 1</br>Stations: 64");
L.marker([-3.04553,-64.86188],{icon: mapmarker}).addTo(map).bindPopup("<b>RDSM_2013_2014</b></br>Individual: 23</br>Stations: 54");
L.marker([-3.04553,-64.86188],{icon: mapmarker}).addTo(map).bindPopup("<b>RDSM_2014_2015</b></br>Individual: 25</br>Stations: 53");
L.marker([0.25555,-74.5454],{icon: mapmarker}).addTo(map).bindPopup("<b>Rapid Inventory 30 Bajo Caguan, Colombia</b></br>Individual: 8</br>Stations: 30");
L.marker([17.750255,-89.322328],{icon: mapmarker}).addTo(map).bindPopup("<b>Rio Azul 2009</b></br>Individual: 16</br>Stations: 22");
...
L.marker([17.235823,-89.644044],{icon: mapmarker}).addTo(map).bindPopup("<b>Tikal_2005</b></br>Individual: 7</br>Stations: 16");
...
L.marker([-6.60918,-68.23544],{icon: mapmarker}).addTo(map).bindPopup("<b>xerua</b></br>Individual: 35</br>Stations: 41");
</script>